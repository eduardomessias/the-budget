const SimpleListContainer = ({ title, subTitle, visible, children }) => {
    let simpleListContainerStyle = "text-gray-600 body-font overflow-hidden"
    if (!visible)
        simpleListContainerStyle += " hidden"
    return (
        <section className={simpleListContainerStyle}>
