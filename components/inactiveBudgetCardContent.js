...
export default function InactiveBudgetCardContent({ category, title, text, linkText, link }) {
    return (
        <div className="p-6">
            <h2 className="tracking-widest text-xs title-font font-medium text-gray-200 mb-1">{category}</h2>
            <h1 className="title-font text-lg font-medium text-gray-200 mb-3">{title}</h1>
            <p className="leading-relaxed mb-3 text-gray-200">{text}</p>
            <div className="flex items-center flex-wrap ">
                <Link href={link}><a className="text-indigo-100 inline-flex items-center md:mb-2 lg:mb-0">{linkText}
